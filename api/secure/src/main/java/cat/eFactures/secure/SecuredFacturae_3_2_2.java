...
import cat.eFactures.transform.Facturae_3_2_2;

/**
 * Spanish facturae 3.2.2 secured (signed invoice)
 * 
 * @author Joaquín López
 *
 */
public class SecuredFacturae_3_2_2 extends SecuredInvoice {

	/**
	 * Constructor
	 * 
	 * @param xml Invoice facturae3.2.2 invoice to be signed
	 */
	public SecuredFacturae_3_2_2(Facturae_3_2_2 xmlInvoice) {
		super(xmlInvoice);
	}
